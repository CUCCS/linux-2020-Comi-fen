...
[OPTION]
	...
	[-p prefix] [-s suffix] [-j] [-- help] [-d --pathectory]
[DESCRIPTION] 
	-d, --directory     	the directory path of images
	-c, --compress          image quality compression in jpeg format
	-r, --resolution        compress the resolution of jpeg/png/svg images while maintaining the original aspect ratio
	-w, --watermark         add watermarks
	-p, --prefix            add prefix to images' names
	-s, --suffix            add suffix to images' names
	-t, --transform         transform png/svg images into jpg images
